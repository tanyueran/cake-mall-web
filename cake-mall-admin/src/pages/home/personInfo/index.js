      ...
      <Row gutter={6}>
        <Col span={12}>
          <Card
            ...
            style={{width: 300}}>
            <p>姓名：{this.props.user.userInfo.data.userName}</p>
            <p>账号：{this.props.user.userInfo.data.userCode}</p>
            <p>昵称：{this.props.user.userInfo.data.nickname}</p>
            <p>角色：{this.props.user.userInfo.data.roleInfo.roleName}</p>
          </Card>
        </Col>
        <Col span={12}>
